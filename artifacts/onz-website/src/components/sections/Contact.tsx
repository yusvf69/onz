...
export default function Contact() {
  ...
  return (
    <section
      id="contact"
      className="relative bg-[#080808] py-32 overflow-hidden text-white border-t border-primary/20"
    >
      <div className="watermark-text bottom-0 left-0 leading-none">07</div>
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="space-y-8 mt-auto">
              <div className="font-mono-custom text-sm flex flex-col gap-2">
                ...
                <a
                  href="mailto:onz_1_0@zohomail.com"
                  className="hover:text-primary transition-colors"
                  data-testid="link-email"
                >
                  onz_1_0@zohomail.com
                </a>
              </div>
              <div className="font-mono-custom text-sm flex flex-col gap-2">
                <span className="text-white/40 text-[10px] tracking-widest">
          ...
          <div className="relative p-8 md:p-12 border border-white/10 bg-[#080808]/50 backdrop-blur">
            ...
            >
              ...
              <div className="relative group">
                ...
                >
                  <option value="" disabled selected className="bg-[#080808]">
                    PROJECT TYPE
                  </option>
                  <option value="web" className="bg-[#080808]">
                    WEB PLATFORM
                  </option>
                  <option value="mobile" className="bg-[#080808]">
                    MOBILE APP
                  </option>
                  <option value="ai" className="bg-[#080808]">
                    AI INTEGRATION
                  </option>
                ...
                <div className="absolute right-0 top-2 pointer-events-none text-primary font-mono-custom">
                  ↓
                </div>
              </div>
              ...
              <AnimatePresence>
                {error && (
                  <motion.div
                    ...
                    exit={{ opacity: 0, y: -10 }}
                    className="text-red-500 font-mono-custom text-xs text-center"
                  >
                    {error}
                  </motion.div>
                )}
            ...
            <AnimatePresence>
              {formState === "success" && (
                ...
                >
                  ...
                  <div className="font-mono-custom text-sm font-bold tracking-widest">

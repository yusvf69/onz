        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="flex flex-col gap-4">
            <div className="flex items-center gap-2">
              <div className="w-12 h-12 rounded-full border-2 border-[#080808] flex items-center justify-center relative">
                ...
                <span className="absolute text-[#0066FF] font-mono-custom font-bold text-xs bg-[#FAF7F0] px-1">1</span>
              </div>
              <span className="font-display text-3xl tracking-widest mt-1">ONZ</span>
            </div>
            <p className="font-editorial italic text-sm text-[#080808]/70 max-w-xs mt-4">
              One Not Zero since 2018. Elevating digital experiences from the baseline of mediocrity to the pinnacle of perfection.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2 font-mono-custom text-xs font-bold">
              <a href="#about" className="hover:text-primary transition-colors w-fit" data-testid="link-footer-about">01 / ABOUT</a>
              <a href="#services" className="hover:text-primary transition-colors w-fit" data-testid="link-footer-services">02 / SERVICES</a>
              <a href="#founder" className="hover:text-primary transition-colors w-fit" data-testid="link-footer-founder">03 / ARCHITECT</a>
              <a href="#portfolio" className="hover:text-primary transition-colors w-fit" data-testid="link-footer-portfolio">04 / WORK</a>
            </div>
          </div>

          {/* Col 3 */}
          <div className="flex flex-col gap-4">
            <h4 className="font-display tracking-widest text-xl mb-4">NEWSLETTER</h4>
      ...
      <div className="w-full bg-[#080808] py-2 overflow-hidden flex">
        ...
        >
          {Array.from({ length: 20 }).map((_, i) => (
            <span key={i} className="mx-4">01001111 01001110 01011010 00110001</span>
          ))}
        </motion.div>
      </div>
    </footer>
